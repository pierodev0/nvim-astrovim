-- Source: https://github.com/AstroNvim/astrocommunity/blob/main/lua/astrocommunity/file-explorer/oil-nvim/init.lua
return {
    "stevearc/oil.nvim",
    cmd = "Oil",
    dependencies = {
            ...
            opts = function(_, opts)
                if opts.winbar then
                    ...
                    table.insert(opts.winbar, 1, {
                        condition = function(self) return status.condition.buffer_matches({ filetype = "^oil$" },
                                self.bufnr) end,
